...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Tarjetas de Debito</title>
    ...
    <body>
        ...
        <div class="container">
            <div class="row justify-contents-center">
                <div class="col-md-5">
                    <h2><center>Registro de tarjeta de Debito</center></h2>
                    <form action="" method="POST">
                        <div class="form group">
                            <input type="text" name="numero de tarjeta" id="" class="form-control"placeholder="No. de tarjeta"><br>
                        </div>
                        ...
                        <div class="form group">
                            <input type="RFC" name="RFC" id="" class="form-control"placeholder="Escribir RFC"><br>
